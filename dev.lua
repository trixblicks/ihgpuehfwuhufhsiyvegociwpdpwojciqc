...
local Window = Library:CreateWindow("Trix-Ware Devs Only Version", Vector2.new(492, 598), Enum.KeyCode.RightShift)
...
local TeleportTab = Window:CreateTab("Teleport (DH ONLY)")
